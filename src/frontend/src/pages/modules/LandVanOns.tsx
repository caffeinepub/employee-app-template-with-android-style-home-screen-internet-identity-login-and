...
export default function LandVanOns() {
      ...
      <div className="relative z-10 min-h-screen flex flex-col">
        ...
        <div className="bg-white/90 backdrop-blur-md shadow-lg">
          <div className="max-w-4xl mx-auto px-6 py-4 flex items-center gap-4">
            ...
            <div className="flex items-center gap-3">
              <img 
                src="/assets/generated/icon-land-van-ons.dim_512x512.png" 
                alt="Land van Ons"
                className="w-10 h-10 object-contain"
              />
              <h1 className="text-2xl font-bold text-slate-900">Land van Ons</h1>
            </div>
          </div>
        </div>
        ...
        <div className="flex-1 max-w-4xl mx-auto px-6 py-8 w-full">
          <div className="bg-white/95 backdrop-blur-md rounded-2xl p-8 shadow-xl">
            <h2 className="text-xl font-semibold text-slate-900 mb-4">Welcome to Land van Ons</h2>
            <p className="text-slate-700 leading-relaxed mb-4">
              This is a placeholder module for Land van Ons. Here you can add content, features, and functionality specific to this module.
            </p>
